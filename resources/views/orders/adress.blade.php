...
<div class="container">
    <div class="row" id="adressUser">
        ...
        <span class="col-md-12" id="text"> Selecione algum desses endereços já cadastrados por você para receber o pedido, caso o endereço
                        certo não esteja aqui, cadastre-o mais abaixo.</span>
        <hr style="width: 100% ;">
        @foreach ($query as $row)
            <div class="col-md-4" id="infos">
                <div class="col-md-12" id="bairro"><small> Bairro:<strong> {{ $row->bairro }} </strong></small></div>
                <div class="col-md-12" id="rua"><small> Rua:<strong> {{ $row->rua }}
                            , {{ $row->complemento }} {{ $row->numero }}
                        </strong></small></div>
                <div class="col-md-12" id="complemento"><small> Referência:
                        <strong> {{ $row->referencia }} </strong></small></div>
                <div class="col-md-12" id="cep"><small> CEP: <strong> {{ $row->cep }}</strong></small></div>
                <form method="post" action="{{asset('/update_adress')}}">
                    ...
                    <input type="submit" id="sendAdress" class="col-md-7 btn btn-primary" value="Enviar para este endereço">
        ...
        @endforeach
        <div class="col-md-4" id="infos">
            <div class="col-md-12" id="bairro"><small> Endereço: <strong> Restaurante </strong></small></div>
            <div class="col-md-12" id="bairro"><small> Bairro:<strong> Parangaba </strong></small></div>
            <div class="col-md-12" id="rua"><small> Rua:<strong> Não sei
                        , 118
                    </strong></small></div>
            <div class="col-md-12" id="complemento"><small> Referência:
            ...
            <form method="post" action="{{asset('/store')}}">
                {{ csrf_field() }}
                <input type="submit" id="sendAdress" class="col-md-7 btn btn-primary" value="Retirar no restaurante">
            </form>
        </div>
    </div>
    <hr style="width: 100% ;">
            ...
            <div class="d-flex justify-content-center form_container">
                <form method="post" id="addAdress" action="{{ asset('/add_adress')}}">
                    ...
                    <div class="container">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" name="bairro" id="bairroInput" placeholder="Bairro" class="form-control"
                                   autocomplete="off">
                        ...
                        <div class="input-group mb-2">
                            <input type="text" id="numberInput" name="number" placeholder="Número" class="form-control"
                                   autocomplete="off">
                        </div>
                        <div class="input-group mb-2">
