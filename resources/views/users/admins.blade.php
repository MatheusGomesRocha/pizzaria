        ...
        <table class="table table-striped " id="tableUsers">
            ...
            @foreach($query as $row)
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary" data-toggle="modal" data-target="#modalExemplo{{$row->id}}"><i class="nav-icon fas fa-edit"></i></button>
                        <div class="modal fade" id="modalExemplo{{$row->id}}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <form method="post" action="{{ route('edit_nivel_admin') }}">
                                        {{ csrf_field() }}
